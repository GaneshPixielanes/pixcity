 ...
 */
class Version20180318141042 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE INDEX index_email ON pxl_user (email)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX index_email ON pxl_user');
