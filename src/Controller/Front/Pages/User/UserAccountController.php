...
class UserAccountController extends Controller
{
     ...
     */
    public function cards(Request $request, CardRepository $cardRepo, CardCategoryRepository $categoriesRepo, RegionRepository $regionsRepo, StaticPagesRepository $staticPages)
    {
        $user = $this->getUser();
        $uri = explode('/',$request->getRequestUri())[3];
