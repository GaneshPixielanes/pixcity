...
//            dd($project);
        ...
        $this->_createNewTransaction($transactions->getProjects(), $cost, $transactions->getType(), $transactions->getStatus(), $transactions->getUser(), $oldName);

        $this->addFlash('success', 'Invocie has been regenerated');
        return $this->redirectToRoute("admin_transactions_list");
    }

    private function _createNewTransaction($unpayedProjects, $totalPayementPending, $type, $status, $user, $name = NULL){
