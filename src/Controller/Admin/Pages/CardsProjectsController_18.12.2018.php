...
class CardsProjectsController extends Controller
{
     ...
     * @Method({"GET", "POST"})
     */
    public function new(Request $request, CardProjectRepository $projects)
    {
...
//            dd($form->getData()->getName());
            $message = "<a href='/pixie/compte/cards/demandes' class='notification-link'>".$form->getData()->getName()."</a> has been assigned to you on ".date('d-M-Y');
            $notification = new Notifications();
            $notification->setSentFrom($this->getUser());
            $notification->setSentTo($form->getData()->getPixie()->getId());
     ...
     * @Method({"GET", "POST"})
     */
    public function edit(Request $request, CardProject $project, TransactionRepository $transactions)
    {
